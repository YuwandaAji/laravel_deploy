        ...
        <main class="main-container">
            ...
            <div class="main-feature">
                ...
                <div class="main-title">
                    <p class="font-weight-bold">PELANGGAN NONCHALANT COFFE</p>
                </div>

                <div class="feature-right">
                    <form class="search" method="get" action={{ url("admin/customers_search") }}>
                    ...
                    <div class="list">
                        <a href={{ url("admin/customers/$customer->customer_id") }} class="inner-list">
                            ...
                            <div class="inner-list-text">
                                <span class="username">{{ $customer->customer_name }}</span>
