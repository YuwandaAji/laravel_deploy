...
<head>
    ...
    <!--Source CSS-->
    <link href={{asset('admin/css/feedbacks.css')}} rel="stylesheet">
</head>
<body>
        ...
        <main class="main-container">
            ...
            <div class="main-feature">
                ...
                <div class="feature-right">
                    <form class="search" method="get" action={{ url("admin/feedbacks_search") }}>
                    ...
                    <div class="filter-container">
                        ...
                        <ul class="menu-filter" id="filter">
                            <li class="filter-item"><a href="{{ url('admin/feedbacks_search?rating=1') }}"><span>Rating 1</span></a></li>
                            <li class="filter-item"><a href="{{ url('admin/feedbacks_search?rating=2') }}"><span>Rating 2</span></a></li>
                            <li class="filter-item"><a href="{{ url('admin/feedbacks_search?rating=3') }}"><span>Rating 3</span></a></li>
                            <li class="filter-item"><a href="{{ url('admin/feedbacks_search?rating=4') }}"><span>Rating 4</span></a></li>
                            <li class="filter-item"><a href="{{ url('admin/feedbacks_search?rating=5') }}"><span>Rating 5</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                @foreach ($feedbacks as $feedback)
                    <div class="list">
                        <div class="inner-list">
                            @if($feedback->sales->customers->customer_img)
                                <img src="{{ asset('storage/' . $feedback->sales->customers->customer_img) }}" alt="image-customer">
                            @else
                                <img src="{{ asset('admin/img/default_profile.png') }}" alt="default_image">
                            @endif
                            <div class="inner-list-text">
                                <span class="username">{{$feedback->sales->customers->customer_name}}</span>
                                <span class="msg">{{$feedback->comment}}</span>
                            </div>
                        ...
                        <div class="rating">
                                ...
                                <span class="number-rating">{{$feedback->rating}}.0</span>
                            </div>
                    </div>
                @endforeach
    ...
    <!--JS SOURCE-->
    <script src={{asset('admin/js/feedbacks.js')}}></script>
</body>
</html>